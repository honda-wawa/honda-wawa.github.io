<template>
  <div>
    <div class="mb-8">
      ...
      <h1 class="text-3xl font-bold">B-Series Transmissions</h1>
      <p class="text-white/60 mt-2">Gear ratios for Honda B-Series transmissions</p>
    </div>
...
const transmissions = useBSeriesTransmissions()
</script>
